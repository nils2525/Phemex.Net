...
namespace Phemex.Net.Interfaces.Clients.FuturesApi
{
    ...
    public interface IPhemexSocketClientFuturesApi : ISocketApiClient<PhemexCredentials>, IDisposable
    {
        ...
        Task<CallResult<UpdateSubscription>> SubscribeToTradeUpdatesAsync(string symbol, Action<DataEvent<PhemexFutureTradeUpdate>> onMessage, CancellationToken ct = default);
    }
}
