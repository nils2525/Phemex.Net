namespace Phemex.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IPhemexUserClientProvider
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, PhemexCredentials credentials, PhemexEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IPhemexRestClient GetRestClient(string userIdentifier, PhemexCredentials? credentials = null, PhemexEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IPhemexSocketClient GetSocketClient(string userIdentifier, PhemexCredentials? credentials = null, PhemexEnvironment? environment = null);
    }
}